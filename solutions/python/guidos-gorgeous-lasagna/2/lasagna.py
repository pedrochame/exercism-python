"""
Constante que armazena o tempo (em minutos) esperado de cozimento de 1 lasanha
"""
EXPECTED_BAKE_TIME = 40

"""
Constante que armazena o tempo (em minutos) de preparação de 1 camada de lasanha
"""
PREPARATION_TIME = 2
